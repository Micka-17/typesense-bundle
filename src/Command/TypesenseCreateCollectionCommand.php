...
use Micka17\TypesenseBundle\Service\TypesenseClient as TypesenseClient;
...
class TypesenseCreateCollectionCommand extends Command
{
    ...
    public function __construct(SchemaGenerator $schemaGenerator, TypesenseClient $typesenseClient, string $projectDir)
    {
